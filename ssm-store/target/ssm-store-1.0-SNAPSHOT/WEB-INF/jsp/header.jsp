    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            <c:if test="${sessionScope.user != null}">
                ...
                <li><a href="${pageContext.request.contextPath}/orderServlet?method=myOrderList&uid=${user.uid}">我的订单</a> </li>
            </c:if>
            <c:if test="${sessionScope.user == null}">
                ...
                <li><a href="userServlet?method=go&username=jack">测试</a></li>
            </c:if>
...
<!--
<script type="application/javascript">写法:
js在服务器生成并解析, 对浏览器js解析要求, 兼容性低 -- 建议浏览器版本尽量高

<script type="text/javascript">
js在服务器生成, 客户端解析, 兼容性高 -- 浏览器版本不用很高
-->
