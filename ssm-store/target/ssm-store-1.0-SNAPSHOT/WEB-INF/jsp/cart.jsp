...
<html>
	...
	<head>
	 ...
	 float:left; */
		...
		<script>
			function dealDel(deleteURL,flag){
				if (confirm(flag=='all' ? '清空购物车吗?' : '狠心干掉?')){
			...
			$(function () {
				...
				$("input[name='quantity']").blur(function () {
					...
					var pid = $(this).attr("pid");  //获取当前商品购买数量文本框中的属性pid - 这个属性并不是html的属性, 是硬加进去的1个自定义属性
					$.ajax({
						url:"cartServlet",
						type:"get",
						data:"method=updateCount&pid="+pid+"&count="+$(this).val(),
                        success:function (data) {
							//data: 100&&&10000
							var dataStrs=data.split("&&&");
							var subTotal = dataStrs[0];
							var total = dataStrs[1];
							//更新页面上的小计 和 总金额
	...
	<jsp:include page="header.jsp"/>
       ...
       <c:choose>
           <%--<c:when test="${cart eq null or cart.size()==0}">--%>
           <c:when test="${cart eq null or fn:length(cart)==0}">
               ...
               <div class="container">
                           ...
                           <table class="table table-bordered">
                               ...
                               <c:forEach items="${sessionScope.cart}" var="entry">
                                   ...
                                   <tr class="active">
                                       ...
                                       <td>
                                           <a href="javascript:dealDel('cartServlet?method=delete&pid=${entry.value.product.pid}','single');" class="delete">删除</a>
                                       </td>
                                   </tr>
                               </c:forEach>
                               </tbody>
                   ...
                   <div style="margin-right:130px;">
                       ...
                       <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                           <a href="javascript:dealDel('cartServlet?method=clear','all')" id="clear" class="clear">清空购物车</a>
